            ...
            <div class="col-6">
                <div class="card">
                    <div class="card-body">
                        ...
                        @endif
                        <form action="/konfigurasi/updatelokasikerja" method="POST">
                            @csrf
                            <div class="row">
                                <div class="col-12">
                                    <div class="input-icon mb-3">
                                        ...
                                        <input type="text" value="{{ $lok_kerja->lokasi_kerja }}" id="lokasi_kerja" class="form-control" placeholder="Lokasi Kerja" name="lokasi_kerja">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-12">
                                    <div class="input-icon mb-3">
                                        ...
                                        <input type="text" value="{{ $lok_kerja->radius }}" id="radius" class="form-control" placeholder="Radius" name="radius">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
